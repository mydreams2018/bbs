 ...
 * @author Keith Donald
 */
public class Jdbc8UsersConnectionRepository implements UsersConnectionRepository {
    ...
    public Jdbc8UsersConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
    ...
    public ConnectionRepository createConnectionRepository(String userId) {
        ...
        return new Jdbc8ConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix);
    }
