...
<head>
    ...
    <script type="text/javascript">
        ...
        function pageChange(obj) {
            ...
            if(obj > end ){
                alert("当前页不能大过总页:");
                window.location.replace("/sendMessage/from?currentPage="+'1');
            }
            window.location.replace("/sendMessage/from?currentPage="+obj);
        };
    ...
    <div class="card-group">
        ...
        <#list ms.datas as messages>
            ...
            <div class="card" onclick="jumpMessage(${(messages.id)!0})">
                <img src="${(messages.toImg)!}" class="card-img-top img-fluid" alt="" style="height: 260px">
                <div class="card-body">
                    <h5 class="card-title">${(messages.toAccount)!}</h5>
