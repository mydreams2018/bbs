...
<head>
    ...
    <script type="text/javascript">
        ...
        function sendPosts() {
            ...
            var form = $("#update-java-posts");
            var da = $.param({'id': ${(posts.id)!}}) + '&' + form.serialize();
            $.ajax({
...
<div class="container pading30">
    <div class="row justify-content-center">
        <div class="col-md">
            <form id="update-java-posts" method="post" action="/assemblerPosts/updatePosts">
                <div class="form-row">
                    <div class="form-group col-md-8">
                        <label for="send-main">主题</label>
                        <input type="email" class="form-control" id="send-main" name="postsName" value="${(posts.postsName)!}">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="summernote" name="detailData">
                        ${(detail.detailData)!}
                    </textarea>
                </div>
